...
- [Fix] PR-019 / #23: Jud Wiebe invalid AllTrails slug is not published as a link. Issue: https://github.com/flysoftware-git/road-trip-generator/issues/23. Report: [PR-019-jud-wiebe-trail-unavailable-link-should-be-discarded.md](PR-019-jud-wiebe-trail-unavailable-link-should-be-discarded.md)
...
- [Fix] PR-022 / #26: Category-style activity does not resolve to ambiguous maps search link. Issue: https://github.com/flysoftware-git/road-trip-generator/issues/26. Report: [PR-022-category-vs-location-san-juan-river-fly-fishing.md](PR-022-category-vs-location-san-juan-river-fly-fishing.md)
