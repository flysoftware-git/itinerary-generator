...
- `destination-type-coverage.md`: the quality gate's thresholds were calibrated on park destinations; a non-park run loses 77% of its dining. Also records markdown emphasis leaking into published names.
