# Itinerary Generator — Design Document

**Version 2.2 · August 18, 2026**
Describes generator `v2.1.0`, template `v2.5`, branch `v2`.
...
│   ├── vehicle_range_miles?              ← wins over en_route_stops.vehicle_range_miles
...
| `run_ledger.jsonl` | stage timings, per-branch spans and pool utilisation (§5.3), gate-A metrics, breaker stats, banned-phrase counts, retry efficiency, CLI flags, cost, route freshness |
