...
def test_moab_group_manifest_parses_discovers_and_renders_with_correct_grouping(_no_network) -> None:
    ...
    # full block -- no separate "Based from X (see Y)" pointer line, and
    # (project-owner review, 2026-08-19) no lodging text in the
    # group-child-banner top row either, just the linked reference.
